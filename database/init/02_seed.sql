-- A few problems so /search returns something before the real corpus is loaded.
-- Embeddings are left NULL here; run `python -m app.db.init_db --embed` from
-- backend/ to fill them in once GEMINI_API_KEY is set.

INSERT INTO problems (title, description, platform, difficulty, source_url)
VALUES
  ('Minimum Path Sum',
